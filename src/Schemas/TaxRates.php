...
class TaxRates extends Schema {
	...
	public $columns = array(
			array( 'name' => 'tax_rate_id', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'extra' => 'auto_increment', 'primary' => true ),
			...
			array( 'name' => 'tax_rate_priority', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'default' => false ),
			array( 'name' => 'tax_rate_compound', 'type' => 'int', 'length' => '1', 'unsigned' => false, 'default' => '0' ),
			array( 'name' => 'tax_rate_shipping', 'type' => 'int', 'length' => '1', 'unsigned' => false, 'default' => '1' ),
			array( 'name' => 'tax_rate_order', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'default' => false ),
