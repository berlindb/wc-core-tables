 ...
 *
 * Introspected from the live WooCommerce table `wp_woocommerce_order_itemmeta` (structure only).
...
class OrderItemmeta extends Schema {
	...
	public $indexes = array(
			...
			array( 'type' => 'key', 'name' => 'order_item_id', 'columns' => array( 'order_item_id' ) ),
